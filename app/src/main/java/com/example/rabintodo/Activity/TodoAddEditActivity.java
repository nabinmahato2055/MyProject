...
public class TodoAddEditActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ID =
            "com.example.nabinmahatotodoapp.EXTRA_ID";

    public static final String EXTRA_TITLE =
            "com.example.nabinmahatotodoapp.EXTRA_TITLE";

    public static final String EXTRA_DESCRIPTION =
            "com.example.nabinmahatotodoapp.EXTRA_DESCRIPTION";

    public static final String EXTRA_PRIORITY =
            "com.example.nabinmahatotodoapp.EXTRA_PRIORITY";
    ...
    private void saveTodo() {
        ...
        if (title.trim().isEmpty() || description.trim().isEmpty()) {
            Toast.makeText(this, "Please check your title or description", Toast.LENGTH_SHORT).show();
            return;
        }
