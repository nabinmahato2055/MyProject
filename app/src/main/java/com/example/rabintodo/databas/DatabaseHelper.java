...
import com.example.rabintodo.LoginSignUp.User;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static class AdapterForTodo extends RecyclerView.Adapter<AdapterForTodo.TodoHolder> {
